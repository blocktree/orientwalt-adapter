...
func (bs *HTDFBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *HTDFBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *HTDFBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *HTDFBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *HTDFBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *HTDFBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *HTDFBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
