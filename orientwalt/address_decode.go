...
func (dec *AddressDecoderV2) AddressDecode(addr string, opts ...interface{}) ([]byte, error) {
	if strings.Index(addr, prefix) != 0 {
		return nil, errors.New("invalid address")
	}
	decodeHash, err := orientwaltTransaction.Bech32Decode(addr)
	if err != nil {
		return nil, err
	}
...
func (dec *AddressDecoderV2) AddressEncode(hash []byte, opts ...interface{}) (string, error) {
	...
	address := orientwaltTransaction.Bech32Encode(prefix, bech32Alphabet, pkHash)
	return address, nil
}
...
func (dec *AddressDecoderV2) AddressVerify(address string, opts ...interface{}) bool {
	...
	_, err := orientwaltTransaction.Bech32Decode(address)
	if err != nil {
		return false
	}
	return true
