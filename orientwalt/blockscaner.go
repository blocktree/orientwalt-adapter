...
//HTDFBlockScanner atom的区块链扫描器
type HTDFBlockScanner struct {
...
//NewHTDFBlockScanner 创建区块链扫描器
func NewHTDFBlockScanner(wm *WalletManager) *HTDFBlockScanner {
	bs := HTDFBlockScanner{
...
func (bs *HTDFBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
//ScanBlockTask 扫描任务
func (bs *HTDFBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *HTDFBlockScanner) ScanBlock(height uint64) error {
...
func (bs *HTDFBlockScanner) scanBlock(height uint64) (*Block, error) {
...
func (bs *HTDFBlockScanner) ScanTxMemPool() {
...
func (bs *HTDFBlockScanner) RescanFailedRecord() {
...
func (bs *HTDFBlockScanner) newBlockNotify(block *Block, isFork bool) {
...
func (bs *HTDFBlockScanner) BatchExtractTransaction(blockHeight uint64, blockHash string, txs []string, memPool bool) error {
...
func (bs *HTDFBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *HTDFBlockScanner) ExtractTransaction(blockHeight uint64, blockHash string, txid string, scanAddressFunc openwallet.BlockScanTargetFunc, memPool bool) ExtractResult {
...
func (bs *HTDFBlockScanner) extractTransaction(trx *Transaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanTargetFuncV2) {
	var (
		success    = true
		multiindex = uint64(0)
	)
...
func (bs *HTDFBlockScanner) newExtractDataNotify(height uint64, extractData map[string]*openwallet.TxExtractData) error {
...
func (bs *HTDFBlockScanner) DeleteUnscanRecordNotFindTX() error {
...
func (bs *HTDFBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
	var (
...
func (bs *HTDFBlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *HTDFBlockScanner) GetScannedBlockHeight() uint64 {
	localHeight, _, _ := bs.wm.Blockscanner.GetLocalNewBlock()
	return localHeight
}

func (bs *HTDFBlockScanner) ExtractTransactionData(txid string, scanTargetFunc openwallet.BlockScanTargetFunc) (map[string][]*openwallet.TxExtractData, error) {
...
func (bs *HTDFBlockScanner) GetSourceKeyByAddress(address string) (string, bool) {
	bs.Mu.RLock()
	defer bs.Mu.RUnlock()
...
func (bs *HTDFBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *HTDFBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
func (bs *HTDFBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
func (bs *HTDFBlockScanner) GetTransactionsByAddress(offset, limit int, coin openwallet.Coin, address ...string) ([]*openwallet.TxExtractData, error) {
...
//Run 运行
func (bs *HTDFBlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *HTDFBlockScanner) Stop() error {
...
//Pause 暂停扫描
func (bs *HTDFBlockScanner) Pause() error {
...
//Restart 继续扫描
func (bs *HTDFBlockScanner) Restart() error {
...
func (bs *HTDFBlockScanner) setupSocketIO() error {
	...
	if bs.socketIO == nil {
		...
		apiUrl, err := url.Parse(bs.wm.Config.RestAPI)
		if err != nil {
			return err
		}
...
//@optional
func (bs *HTDFBlockScanner) SupportBlockchainDAI() bool {
	return true
}
